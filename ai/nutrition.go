...
func (c Classifier) GetGetNutritionDataByImage(img *bytes.Buffer, description string) (data.Food, error) {
	...
	result, err := c.RecognizeImage(*img, systemQuery, description)
	if err != nil {
		log.Println(err)
...
func (c Classifier) GetNutritionData(description string) (data.Food, error) {
...
func (c Classifier) GetNutritionDataOneStep(description string) (data.Food, error) {
	...
	result, err := c.QuerySimple(systemQuery, description, 0)
	if err != nil {
		log.Println(err)
		return data.Food{}, err
	}
...
func (c Classifier) GetNutritionDataTwoSteps(description string) (data.Food, error) {
	...
	result1, err := c.QuerySimple(systemQuery1, description, 0)
	if err != nil {
		log.Println(err)
		return data.Food{}, err
	}
	...
	result2, err := c.QuerySimple(systemQuery2, result1, 0)
	if err != nil {
		log.Println(err)
		return data.Food{}, err
	}
